...
<form:form modelAttribute="foodRequest" action="${form_action}" method="post">
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
	<h4 class="modal-title">
		<spring:message code="food.upload.header" arguments="${foodRequest.name}" />
	</h4>
</div>
<div class="modal-body">
	<form:hidden path="id"/>
	<div class="form-group" id="input-name-group">
		<label for="input-name"><spring:message code="food.form.label.name" /></label>
