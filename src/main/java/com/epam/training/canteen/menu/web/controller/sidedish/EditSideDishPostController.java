...
@Controller
public class EditSideDishPostController {

	public static final String REQUEST_MAPPING = "/admin/side_dishes/edit";
	private static final String REDIRECT_URL = "redirect:" + SideDishesController.REQUEST_MAPPING;
	private static final String SUCCESS_MESSAGE = "sidedish.edit.success.message";
